<?php
	...
	require_once './init.videoDelete.inc.php';
				...
				<div class="col-xs-12 | col-sm-12 | col-md-12 col-lg-12 | centered"  id="form-box">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-xs-offset-0 | col-sm-10 col-sm-offset-1 | col-md-10 col-md-offset-1 | col-lg-10 col-lg-offset-1 text-left">
							<h4 class="help-block"><strong>Delete Video</strong></h4>
						</div>
						...
						<form action="./videoDelete.inc.php" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 | col-sm-10 col-sm-offset-1 | col-md-10 col-md-offset-1 | col-lg-10 col-lg-offset-1">
									<h4 class="help-block">
										<strong>
											<?php echo 'Video Title : '.htmlentities($title); ?>
										</strong>
									</h4>
								</div>
								...
								<div class="col-xs-12 | col-sm-10 col-sm-offset-1 | col-md-10 col-md-offset-1 | col-lg-10 col-lg-offset-1">
									<h6 class="help-block">
										<strong>
											<?php echo 'Publsihed on : '.htmlentities(date('jS M,Y g:ia', strtotime($published))); ?>
										</strong>
									</h6>
								</div>
								...
								<div class="col-xs-12 | col-sm-10 col-sm-offset-1 | col-md-10 col-md-offset-1 | col-lg-10 col-lg-offset-1 text-center">
									<button type="submit" class="btn btn-danger" name="delete_button">Delete Video</button>
								</div>
