<?php
	...
	require_once 'init.userChannel.inc.php';
...
?>
							...
							<nav aria-label="Page navigation centered">
								<ul class="pagination">
									<li>
										<a href="<?php echo htmlentities('./userChannel.php?page='.($page-1)); ?>" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
										</a>
									</li>
									<li <?php if($page == 1 || $page == 2) echo 'class="hidden"'; ?>><a href="<?php echo htmlentities('./userChannel.php?page='.($page-2)); ?>"><?php echo $page-2; ?></a></li>
									<li <?php if($page == 1) echo 'class="hidden"'; ?>><a href="<?php echo htmlentities('./userChannel.php?page='.($page-1)); ?>"><?php echo $page-1; ?></a></li>
									<li class="active"><a href="<?php echo htmlentities('./userChannel.php?page='.($page)); ?>"><?php echo $page; ?></a></li>
									<li <?php if($next == 0) echo 'class="hidden"'; ?>><a href="<?php echo htmlentities('./userChannel.php?page='.($page+1)); ?>"><?php echo $page+1; ?></a></li>
									<li <?php if($next == 0) echo 'class="hidden"'; ?>><a href="<?php echo htmlentities('./userChannel.php?page='.($page+2)); ?>"><?php echo $page+2; ?></a></li>
									<li <?php if($next == 0) echo 'class="hidden"'; ?>>
										<a href="<?php echo htmlentities('./userChannel.php?page='.($page+1)); ?>" aria-label="Next">
