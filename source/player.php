		...
		<div id="player" class="fluid">
			...
			<div id="video-container" class="embed-responsive embed-responsive-16by9">
				<video id="video" class="embed-responsive-item" 
					...
					<source
					src="<?php
							echo htmlentities($videosPath.$video_filename);
						?>" type="video/mp4">
					<?php
			...
			<div id="button_container" class="col-xs-12 | col sm-12 | col-md-12 | col-lg-12">
				...
				<div class="pull-right">
					<!-- Audio switch Button -->
					<button type="button" onclick="window.location.href='player2.php?video=<?php echo $url; ?>'" class=" btn btn-sm btn-primary text-nowrap <?php if($audio_filename == NULL) echo 'hidden'; ?>" id="audio_button">
